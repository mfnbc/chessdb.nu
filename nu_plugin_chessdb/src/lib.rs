...
impl Plugin for ChessdbPlugin {
    ...
    fn commands(&self) -> Vec<Box<dyn nu_plugin::PluginCommand<Plugin = Self>>> {
        vec![
            ...
            Box::new(is_legal_cmd::GivesCheckCmd),
            ...
            Box::new(geometry_cmd::SquareDistanceCmd),
            Box::new(board_pieces_cmd::BoardPiecesCmd),
            Box::new(board_pieces_cmd::BoardPiecesAsciiCmd),
            Box::new(board_pieces_cmd::BitboardMaskCmd),
